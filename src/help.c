...
const char *kg_help_lines[] = {
	...
	"│ M-g      goto line      │ M-x      named command  │ C-x f    set fill column│",
	"├─────────────────────────┼─────────────────────────┼─────────────────────────┤",
	...
	"│ C-S-arrow  word/para    │ C-x r d  delete rect    │ C-x 0/1  del wnd/others │",
	"│ S-PgUp/Dn  extend page  │ C-x r c  clear rect     │ C-s/C-r  search fwd/bk  │",
	"│ C-w/S-Del  cut          │                         │ M-%      query replace  │",
	"│ M-w/C-Ins  copy         │ MACROS                  │ C-l      recenter       │",
	"│ C-y/S-Ins  paste        │ C-x (/F3 begin macro    │ C-g      cancel         │",
	"│ DEL        del region   │ C-x )/F4 end macro      │ C-h      help           │",
	"│ M-!/M-|    shell cmd ±  │ C-x e/F4 exec macro     │ C-z      suspend        │",
	"│                         │                         │ C-u      numeric arg    │",
	"└─────────────────────────┴─────────────────────────┴─────────────────────────┘",
